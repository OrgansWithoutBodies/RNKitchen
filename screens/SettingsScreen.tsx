  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ width: '90%', height: '15%', flexDirection: 'row' }}>
        <Text style={{ flex: 1, fontSize: 18, justifyContent: 'flex-end' }}>Grocy URL</Text>
        <TextInput
          editable
          placeholder='http(s)://...'
      ...
      <View style={{ width: '90%', height: '15%', flexDirection: 'row' }}>
        <Text style={{ flex: 1, fontSize: 20, justifyContent: 'flex-end' }}>Grocy API</Text>
        <TextInput
          editable
          placeholder='API'
      ...
      {/* TODO IO API Key? */}
      <View style={{ width: '90%', height: '15%', flexDirection: 'row' }}>
        <Text style={{ flex: 1, fontSize: 18, justifyContent: 'flex-end' }}>IO Server URL</Text>
        <TextInput
          editable
          placeholder='http(s)://...'
      ...
      <Button title='Scan QR' onPress={async () => {
          ...
          <Camera
            ...
            onBarCodeScanned={(result) => {
              ...
              if (scannedAPI) {
                ...
                ToastAndroid.show("Not a valid grocy code!", ToastAndroid.CENTER)
              }
